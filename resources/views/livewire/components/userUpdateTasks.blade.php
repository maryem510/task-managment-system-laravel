{{-- update tasks model --}}
<div class="modal fade" wire:ignore.self id="updateTasks" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <form action="" wire:submit.prevent='update({{ $edit_id }})'>
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" disabled wire:model.lazy='edit_title' class="form-control form-control-lg">
                        @error('edit_title')
